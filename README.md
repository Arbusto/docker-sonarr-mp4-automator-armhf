# aront/sonarr-armhf
A docker container based on lsioarmhf/sonarr with mp4 automation baked in
...
## Parameters
See [https://hub.docker.com/r/lsioarmhf/sonarr/](https://hub.docker.com/r/lsioarmhf/sonarr/) for details.
